...
class UserController extends Controller
{
    public function index(Request $request): View{
        ...
        $data1 = Model_has_role::whereNotIn('role_id', [1])->orderBy('model_id', 'desc')->pluck('model_id');
    ...
    public function create(){
        ...
        return view('users.create', compact('courses' , 'roles'));
    }
     ...
     public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'role' => 'required|integer|exists:roles,id' // Validate role ID exists
        ]);
        ...
        // Fetch the role name from role ID
        $role = \Spatie\Permission\Models\Role::find($request->input('role'));
        ...
        $userDetailsData = $request->only([
            'dob', 'married', 'contact', 'father_name', 'mother_name',
            'father_mobile', 'mother_mobile', 'address', 'city', 'state',
            'course', 'student_batch', 'batch_professor', 'fee',
            'aadhaar_card_number', 'course_start_date'
        ]);
        ...
        return redirect()->route('users.index')
            ->with('success', 'User and details created successfully with role: ' . $role->name);
    }
    ...
    public function show($id): View{
        ...
        return view('users.show', compact('user', 'slectedCourse' , 'courseBatch' , 'proffesors'));
    }
    ...
    public function edit($id){
        ...
        return view('users.edit', compact('user', 'courses','courseBatch' , 'proffesors'));
    }
